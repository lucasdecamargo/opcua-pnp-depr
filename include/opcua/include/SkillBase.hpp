...
#ifndef OPCUA_SKILL_BASE_H
#define OPCUA_SKILL_BASE_H
#pragma once
        ...
        namespace skill {
            ...
            public:
                explicit SkillBase(
                        ...
                        skillTransitionEventTypeId(UA_NODEID_NUMERIC(pnp::opcua::UA_Server_getNamespaceIdByName(
                                server, NAMESPACE_URI_FORTISS_DEVICE), UA_DEVICE_MODELID_SKILLTRANSITIONEVENTTYPE)) {
            ...
            private:
                static const std::vector<ProgramState> generateStates(const std::shared_ptr<pnp::opcua::OpcUaServer>& server) {
                ...
                generateTransitions(const std::shared_ptr<pnp::opcua::OpcUaServer>& server) {
